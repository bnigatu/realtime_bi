...
/**
  * This is a sample stream generator
 */
object LogProducer extends App {
  // WebLog config
  val wlc = Settings.WebLogGen
  val kc = Settings.Kafka
  ...
  props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kc.bootstrap_servers_config)
  props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, kc.key_serializer_class_config)
  props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, kc.value_serializer_class_config)
  props.put(ProducerConfig.ACKS_CONFIG, kc.acks_config)
  props.put(ProducerConfig.CLIENT_ID_CONFIG, kc.client_id_config)
